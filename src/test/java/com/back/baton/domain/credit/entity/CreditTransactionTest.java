...
class CreditTransactionTest {
    ...
    void create_fields() {
        CreditTransaction tx = CreditTransaction.create(
                1L, 10L, CreditTransactionType.ESCROW_HOLD, -5000, 5000, "보상 처리"
        );
    ...
    void create_withoutRelatedTrade() {
        CreditTransaction tx = CreditTransaction.create(
                1L, null, CreditTransactionType.WELCOME, 10000, 10000, "웰컴 크레딧"
        );
    ...
    void create_debitAmountIsNegative() {
        CreditTransaction tx = CreditTransaction.create(
                1L, null, CreditTransactionType.PURCHASE_DEBIT, -3000, 7000, null
        );
